...
public class ExploreRecipesRecyclerViewAdapter
        extends RecyclerView.Adapter<ExploreRecipesRecyclerViewAdapter.ViewHolder> {

    private final List<RecipeRealm> mValues;
    private final ExploreRecipesFragment.OnListFragmentInteractionListener mListener;

    public ExploreRecipesRecyclerViewAdapter(List<RecipeRealm> items,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_explore_recipes_list, parent, false);
