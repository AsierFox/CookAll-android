...
class DialogListStyle extends Style {
    ...
    static DialogListStyle parse(Context context, AttributeSet attrs) {
        ...
        //Unread bubble
        style.dialogUnreadBubbleEnabled = typedArray.getBoolean(
        ...
        //Last message avatar
        style.dialogMessageAvatarEnabled = typedArray.getBoolean(
        ...
        //Divider
        style.dialogDividerEnabled = typedArray.getBoolean(
