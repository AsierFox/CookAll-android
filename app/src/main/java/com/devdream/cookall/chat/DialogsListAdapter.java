...
public class DialogsListAdapter
    ...
    private List<ChatDTO> items = new ArrayList<>();
    private int itemLayoutId;
    private Class<? extends BaseDialogViewHolder> holderClass;
    private ImageLoader imageLoader;
    private OnDialogClickListener<ChatDTO> onDialogClickListener;
    private OnDialogViewClickListener<ChatDTO> onDialogViewClickListener;
    private OnDialogLongClickListener<ChatDTO> onLongItemClickListener;
    private OnDialogViewLongClickListener<ChatDTO> onDialogViewLongClickListener;
     ...
     */
    public void setItems(List<ChatDTO> items) {
        this.items = items;
        notifyDataSetChanged();
    }
     ...
     */
    public void addItems(List<ChatDTO> newItems) {
        if (newItems != null) {
            if (items == null) {
                items = new ArrayList<>();
            }
     ...
     */
    public void addItem(ChatDTO dialog) {
        items.add(dialog);
     ...
     */
    public void addItem(int position, ChatDTO dialog) {
     ...
     */
    public void updateItem(int position, ChatDTO item) {
        if (items == null) {
            items = new ArrayList<>();
        }
     ...
     * @param item new dialog item
     */
    public void updateItemById(ChatDTO item) {
        if (items == null) {
            items = new ArrayList<>();
        }
        for (int i = 0; i < items.size(); i++) {
     ...
     */
    public void sort(Comparator<ChatDTO> comparator) {
     ...
     */
    public void setOnDialogClickListener(OnDialogClickListener<ChatDTO> onDialogClickListener) {
     ...
     */
    public void setOnDialogViewClickListener(OnDialogViewClickListener<ChatDTO> clickListener) {
     ...
     */
    public void setOnDialogLongClickListener(OnDialogLongClickListener<ChatDTO> onLongItemClickListener) {
     ...
     */
    public OnDialogViewLongClickListener<ChatDTO> getOnDialogViewLongClickListener() {
     ...
     */
    public void setOnDialogViewLongClickListener(OnDialogViewLongClickListener<ChatDTO> clickListener) {
